namespace LimitObjectsCreatedViaNewAction.Win {
	partial class LimitObjectsCreatedViaNewActionWindowsFormsApplication {
		/// <summary> 
		...
		private void InitializeComponent() {
			...
			this.module4 = new LimitObjectsCreatedViaNewAction.Module.Win.LimitObjectsCreatedViaNewActionWindowsFormsModule();
			...
			// sqlConnection1
			// 
			this.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=LimitObjectsCreatedViaNewAction;Integrated Security=SSPI;Pooling=false";
			...
			this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.LimitObjectsCreatedViaNewActionWindowsFormsApplication_DatabaseVersionMismatch);
		...
		private LimitObjectsCreatedViaNewAction.Module.Win.LimitObjectsCreatedViaNewActionWindowsFormsModule module4;
