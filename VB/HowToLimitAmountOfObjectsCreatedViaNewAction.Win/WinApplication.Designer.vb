...
Namespace LimitObjectsCreatedViaNewAction.Win
	Partial Public Class LimitObjectsCreatedViaNewActionWindowsFormsApplication
		''' <summary> 
		...
		Private Sub InitializeComponent()
			...
			Me.module4 = New LimitObjectsCreatedViaNewAction.Module.Win.LimitObjectsCreatedViaNewActionWindowsFormsModule()
			...
			' sqlConnection1
			' 
			Me.sqlConnection1.ConnectionString = "Data Source=(local);Initial Catalog=LimitObjectsCreatedViaNewAction;Integrated Security=SSPI;Pooling=false"
			Me.sqlConnection1.FireInfoMessageEventOnUserErrors = False
			' 
			' LimitObjectsCreatedViaNewActionWindowsFormsApplication
			' 
...
'			Me.DatabaseVersionMismatch += New System.EventHandler(Of DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs)(Me.LimitObjectsCreatedViaNewActionWindowsFormsApplication_DatabaseVersionMismatch);
		...
		Private module4 As LimitObjectsCreatedViaNewAction.Module.Win.LimitObjectsCreatedViaNewActionWindowsFormsModule
