...
Namespace LimitObjectsCreatedViaNewAction.Win
	Partial Public Class LimitObjectsCreatedViaNewActionWindowsFormsApplication
		...
		Private Sub LimitObjectsCreatedViaNewActionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
