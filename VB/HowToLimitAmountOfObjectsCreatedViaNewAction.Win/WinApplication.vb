...
Partial Public Class HowToLimitAmountOfObjectsCreatedViaNewActionWindowsFormsApplication
	...
	Private Sub HowToLimitAmountOfObjectsCreatedViaNewActionWindowsFormsApplication_DatabaseVersionMismatch(ByVal sender As Object, ByVal e As DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs) Handles MyBase.DatabaseVersionMismatch
