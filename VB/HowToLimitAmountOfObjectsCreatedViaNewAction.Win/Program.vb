...
Imports HowToLimitAmountOfObjectsCreatedViaNewAction.Win
...
Public Class Program
    ...
    Public Shared Sub Main(ByVal arguments() As String)
        ...
        Dim _application As HowToLimitAmountOfObjectsCreatedViaNewActionWindowsFormsApplication = New HowToLimitAmountOfObjectsCreatedViaNewActionWindowsFormsApplication()
